---
title: Vite
titleTemplate: Инструмент для фронтенд-разработки следующего поколения
...
<div class="VPHome">
  <Hero/>
  <FeatureSection title="Переопределение опыта разработчика" description="Vite делает веб-разработку снова простой" type="blue">
    <FeatureInstantServerStart />
    <FeatureHMR />
    <FeatureRichFeatures />
    <FeatureOptimizedBuild />
  </FeatureSection>
  <FeatureSection title="Общий фундамент для строительства" type="pink" class="feature-section--flip">
